...
- [x] 获取access_token
- [x] 获取签名
- [x] [https://github.com/zymfe/VueNode/blob/dev/fe/src/libs/wx/index.ts](使用JS-SDK所需配置)
- [x] 自定义公众号底部菜单栏
- [x] 消息接收与回复
- [x] 添加素材
- [x] 发送模板消息
...
当前服务使用 Koa 框架实现，如果对 Koa 实现原理感兴趣，可参考：《[逐行分析Koa源码](https://github.com/zymfe/notebook/tree/master/Node.js/Koa)》
